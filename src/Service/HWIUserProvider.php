...
class HWIUserProvider implements UserProviderInterface, OAuthAwareUserProviderInterface
{
    ...
    public function loadUserByOAuthUserResponse(UserResponseInterface $response): ?UserInterface
    {
        ...
        if (null === $user && $response->getEmail()) {
            ...
            if ($user) {
                ...
                $fieldName = $this->properties[$resourceOwnerName];
                $fieldValue = $username;

                $this->propertyAccessor->setValue($user, $fieldName, $fieldValue);
